...
def load_config(config_path: str) -> Dict:
    ...
    Kept here so the file is parsed exactly once per run and the resulting
    dictionary is passed around, rather than each component re-reading it.
...
class PlaceConfig(TypedDict):
    ...
    type: str  # Place type: cafe, library, etc. (required)
